...
/**
 * TTrnConsequentialLossQuo generated by hbm2java
 */
public class TTrnConsequentialLossQuo extends POJO implements java.io.Serializable {

	private TTrnConsequentialLossQuoId id;
	...
	public TTrnConsequentialLossQuo() {
	}

	public TTrnConsequentialLossQuo(TTrnConsequentialLossQuoId id,
	...
	public TTrnConsequentialLossQuoId getId() {
		return this.id;
	}

	public void setId(TTrnConsequentialLossQuoId id) {
		this.id = id;
	}
	...
	public void setPOJOId( POJOId id ){
		setId((TTrnConsequentialLossQuoId)id);
	}
