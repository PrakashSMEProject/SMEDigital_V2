 ...
 * </ol>
 * Get an instance of this class by making a call to <code>BeanMapperFactory.getMapperInstance( TTrnGaccPersonVOHolderToTTrnGaccPerson.class )</code>.
 */
public class TTrnGaccPersonVOHolderToTTrnGaccPerson extends BaseBeanToBeanMapper<com.rsaame.pas.vo.svc.TTrnGaccPersonVOHolder, com.rsaame.pas.dao.model.TTrnGaccPersonQuo>{
	private final Logger log = Logger.getLogger( this.getClass() );	

	public TTrnGaccPersonVOHolderToTTrnGaccPerson(){
		super();
	}

	public TTrnGaccPersonVOHolderToTTrnGaccPerson( com.rsaame.pas.vo.svc.TTrnGaccPersonVOHolder src, com.rsaame.pas.dao.model.TTrnGaccPersonQuo dest ){
		super( src, dest );
	}
	 ...
	 */
	@Override
	public com.rsaame.pas.dao.model.TTrnGaccPersonQuo mapBean(){
		...
		if( Utils.isEmpty( dest ) ){
			dest = (com.rsaame.pas.dao.model.TTrnGaccPersonQuo) Utils.newInstance( "com.rsaame.pas.dao.model.TTrnGaccPersonQuo" );
		}
		...
		com.rsaame.pas.dao.model.TTrnGaccPersonQuo beanB = dest;
		...
		/*todo not mapped via mapper */
		if(  !Utils.isEmpty( beanA.getGprValidityStartDate() )  ){
 			beanB.getId().setVSD(  beanA.getGprValidityStartDate() ); 
 		}
	 ...
	 */
	private static com.rsaame.pas.dao.model.TTrnGaccPersonQuo initializeDeepVO( com.rsaame.pas.vo.svc.TTrnGaccPersonVOHolder beanA, com.rsaame.pas.dao.model.TTrnGaccPersonQuo beanB ){
