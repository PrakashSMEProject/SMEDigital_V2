...
/**
 * @author M1037404 Modified By : M1044786
 *
 */
@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
public class MandatoryCovers {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MandatoryCovers other = (MandatoryCovers) obj;
		if (coverDesc == null) {
	...
	public String toString() {
		return "MandatoryCovers [coverDesc=" + coverDesc + ", premium=" + premium + ", coverIncluded=" + coverIncluded
