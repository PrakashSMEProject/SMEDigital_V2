 ...
 */
public class ContentsToVMasPasFetchBasicDtlsReverse extends BaseBeanToBeanMapper<com.rsaame.pas.dao.model.VMasPasFetchBasicDtls, com.rsaame.pas.vo.app.Contents>{
	private final Logger log = Logger.getLogger( this.getClass() );	

	public ContentsToVMasPasFetchBasicDtlsReverse(){
		super();
	}

	public ContentsToVMasPasFetchBasicDtlsReverse( com.rsaame.pas.dao.model.VMasPasFetchBasicDtls src, com.rsaame.pas.vo.app.Contents dest ){
		super( src, dest );
	}
	 ...
	 */
	private static com.rsaame.pas.vo.app.Contents initializeDeepVO( com.rsaame.pas.dao.model.VMasPasFetchBasicDtls beanA, com.rsaame.pas.vo.app.Contents beanB ){
                         		return beanB;
	}
}
