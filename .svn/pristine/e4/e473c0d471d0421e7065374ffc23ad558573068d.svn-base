...
/**
 * TTrnSectionLocationId generated by hbm2java
 */
public class TTrnSectionLocationId implements java.io.Serializable, POJOId {
	...
	public TTrnSectionLocationId() {
	}

	public TTrnSectionLocationId(long tslPolLinkingId, long tslPolEndtNo,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TTrnSectionLocationId))
			return false;
		TTrnSectionLocationId castOther = (TTrnSectionLocationId) other;
