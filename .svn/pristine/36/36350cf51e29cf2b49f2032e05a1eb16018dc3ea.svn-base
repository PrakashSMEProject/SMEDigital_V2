...
public class VRenwalStatusEmailReportToRenewalStatusRepVOReverse extends BaseBeanToBeanMapper<com.rsaame.pas.vo.bus.RenewalEmailReportsVO, com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas> {
	private final Logger log = Logger.getLogger( this.getClass() );	

	public VRenwalStatusEmailReportToRenewalStatusRepVOReverse(){
		super();
	}

	public VRenwalStatusEmailReportToRenewalStatusRepVOReverse( com.rsaame.pas.vo.bus.RenewalEmailReportsVO src, com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas dest ){
		super( src, dest );
	}
	 ...
	 */
	@Override
	public com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas mapBean(){
		...
		if( Utils.isEmpty( dest ) ){
			dest = (com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas) Utils.newInstance( "com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas" );
		}
		
		/* Cast the destination bean to a bean of type of BeanA */	
		com.rsaame.pas.vo.bus.RenewalEmailReportsVO beanA = src;
			
		/* Cast the destination bean to a bean of type of BeanB */
		com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas beanB = dest;
	 ...
	 */
	private static com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas initializeDeepVO( com.rsaame.pas.vo.bus.RenewalEmailReportsVO beanA, com.rsaame.pas.dao.model.VRenewalStatusEmailReportPas beanB ){
