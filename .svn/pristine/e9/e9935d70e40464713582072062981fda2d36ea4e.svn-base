 ...
 * </ol>
 * Get an instance of this class by making a call to <code>BeanMapperFactory.getMapperInstance( RequestToHomeInsuranceVOMapper.class )</code>.
 */
public class RequestToHomeInsuranceVOMapper extends BaseBeanToBeanMapper<javax.servlet.http.HttpServletRequest, com.rsaame.pas.vo.bus.HomeInsuranceVO>{

	public RequestToHomeInsuranceVOMapper(){
		super();
	}

	public RequestToHomeInsuranceVOMapper( javax.servlet.http.HttpServletRequest src, com.rsaame.pas.vo.bus.HomeInsuranceVO dest ){
		super( src, dest );
	}
	...
	public com.rsaame.pas.vo.bus.HomeInsuranceVO mapBean(){
		...
		if( !Utils.isEmpty( src.getParameter( "quote_name_colldtKYC" ) ) ){
			com.mindtree.ruc.cmn.beanmap.DateStringConverter converter = ConverterFactory.getInstance( com.mindtree.ruc.cmn.beanmap.DateStringConverter.class, "", com.Constant.CONST_FORMAT_YYYY_MM_DD );
			beanB.getGeneralInfo().getAdditionalInfo()
					.setDateOfcollectionOfKYC( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "quote_name_colldtKYC" ) ) ) );
		}
		else{
		...
		if( !Utils.isEmpty( src.getParameter( "quote_name_tradelicexp" ) ) ){
			com.mindtree.ruc.cmn.beanmap.DateStringConverter converter = ConverterFactory.getInstance( com.mindtree.ruc.cmn.beanmap.DateStringConverter.class, "", com.Constant.CONST_FORMAT_YYYY_MM_DD );
			beanB.getGeneralInfo().getAdditionalInfo()
					.setTradeLicenseExpDate( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "quote_name_tradelicexp" ) ) ) );
		}
		else{
...
//		}
		...
		/* Mapping: "quote_vat_reg_no" -> "generalInfo.insured.vatregno" 142244*/
		...
		/* Mapping: "quote_type_code" -> "getCommonVO().getPremiumVO().setVatCode" 142244*/
		if( !Utils.isEmpty( src.getParameter( "quote_type_code" ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
			beanB.setVatCode(converter.getAFromB( beanA.getParameter( "quote_type_code" ) ));
		...
		if( !Utils.isEmpty( src.getParameter( com.Constant.CONST_QUOTE_NAME_SCHEME ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
			beanB.getScheme().setSchemeCode( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( com.Constant.CONST_QUOTE_NAME_SCHEME ) ) ) );
		}
		

		/* Mapping: "tariff" -> "scheme.tariffCode" */
		if( !Utils.isEmpty( src.getParameter( com.Constant.CONST_QUOTE_NAME_TARIFF ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
			beanB.getScheme().setTariffCode( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( com.Constant.CONST_QUOTE_NAME_TARIFF ) ) ) );
		}
		
		//start :explicitly set scheme code and tariff code for copy quote scenario for broker
		if( Utils.isEmpty( src.getParameter( com.Constant.CONST_QUOTE_NAME_SCHEME ) ) && !Utils.isEmpty( src.getParameter( "quote_dropdwn_scheme_cpquote" ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
			beanB.getScheme().setSchemeCode( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "quote_dropdwn_scheme_cpquote" ) ) ) );
		}
		
		if( Utils.isEmpty( src.getParameter( com.Constant.CONST_QUOTE_NAME_TARIFF ) ) && !Utils.isEmpty( src.getParameter( "quote_dropdwn_tariff_cpquote" ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
			beanB.getScheme().setTariffCode( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "quote_dropdwn_tariff_cpquote" ) ) ) );
		}


		// end :for broker scheme code and tariff code fix
		...
		if( !Utils.isEmpty( src.getParameter( "quote_name_businessclient" ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
			beanB.getGeneralInfo().getClaimsHistory()
					.setOtherBusinessClient( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "quote_name_businessclient" ) ) ) );
		}
		...
		/* Mapping: "intAccExecCode" -> "generalInfo..intAccExecCode" */
		if( !Utils.isEmpty( src.getParameter( com.Constant.CONST_QUOTE_NAME_INTACEXE ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
		...
		/* Mapping: "extAccExecCode" -> "generalInfo.extAccExecCode" */
		if( !Utils.isEmpty( src.getParameter( com.Constant.CONST_QUOTE_NAME_EXTACEXEC ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
		...
		/* Mapping: "quote_name_policyterm" -> "policyTerm" */
		if( !Utils.isEmpty( src.getParameter( "travel_quote_dropdwn_period" ) ) ){
			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, "", "" );
			beanB.setPolicyTerm( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "travel_quote_dropdwn_period" ) ) ) );
		}
