 ...
 */
public class RequesttoCoverdetailsContentList extends BaseBeanToBeanMapper<javax.servlet.http.HttpServletRequest, com.rsaame.pas.vo.bus.CoverDetails>{
	private final Logger log = Logger.getLogger( this.getClass() );	

	public RequesttoCoverdetailsContentList(){
		super();
	}

	public RequesttoCoverdetailsContentList( javax.servlet.http.HttpServletRequest src, com.rsaame.pas.vo.bus.CoverDetails dest ){
		super( src, dest );
	}
	...
	public com.rsaame.pas.vo.bus.CoverDetails mapBean(){
		...
		/* Mapping: "item_name" -> "coverDetails[].coverName" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm1_Desc" );
  	//	index = 0;
 		...
 		/* Mapping: "item_sum" -> "coverDetails[].sumInsured.sumInsured" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, com.Constant.CONST_SHEEPITFORM1_SUMINSURED );
  	  	index = 0;
   		for(String i : noOfItems ){
  		...
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, com.Constant.CONST_SHEEPITFORM1_SUMINSURED );
   		...
   		for(String i : noOfItems ){
			...
			beanB.getCoverDetails().get( index ).getCoverCodes().setCovCode ( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "sheepItForm1_covCode" ) ) ) );
			index++;
   		}
  		...
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, com.Constant.CONST_SHEEPITFORM1_SUMINSURED );
   		...
   		for(String i : noOfItems ){
   			com.rsaame.pas.cmn.converter.ShortStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.ShortStringConverter.class, com.Constant.CONST_BPROPS, com.Constant.CONST_APROPS );
			beanB.getCoverDetails().get( index ).getCoverCodes().setCovTypeCode( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "sheepItForm1_covTypeCode" ) ) ) );
			index++;
   		}
 		...
 		/* Mapping: "risk_basicriskcode" -> "coverDetails[].riskCodes.basicRskCode" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, com.Constant.CONST_SHEEPITFORM1_SUMINSURED );
   		...
   		for(String i : noOfItems ){
			...
			beanB.getCoverDetails().get( index ).getRiskCodes().setBasicRskCode ( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "sheepItForm1_basicRskCode" ) ) ) );
			index++;
   		}
 		...
 		/* Mapping: "risk_riskcode" -> "coverDetails[].riskCodes.riskCode" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, com.Constant.CONST_SHEEPITFORM1_SUMINSURED );
   		...
   		for(String i : noOfItems ){
   			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, com.Constant.CONST_BPROPS, com.Constant.CONST_APROPS );
			beanB.getCoverDetails().get( index ).getRiskCodes().setRiskCode ( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "sheepItForm1_riskCode" ) ) ) );
			index++;
   		}
 		...
 		/* Mapping: "risk_risktype" -> "coverDetails[].riskCodes.riskType" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, com.Constant.CONST_SHEEPITFORM1_SUMINSURED );
   		...
   		for(String i : noOfItems ){
   			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, com.Constant.CONST_BPROPS, com.Constant.CONST_APROPS );
			beanB.getCoverDetails().get( index ).getRiskCodes().setRiskType ( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "sheepItForm1_riskType" ) ) ) );
			index++;
   		}
 		...
 		/* Mapping: "risk_riskcat" -> "coverDetails[].riskCodes.riskCat" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, com.Constant.CONST_SHEEPITFORM1_SUMINSURED );
   		...
   		for(String i : noOfItems ){
   			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, com.Constant.CONST_BPROPS, com.Constant.CONST_APROPS );
			beanB.getCoverDetails().get( index ).getRiskCodes().setRiskCat ( converter.getTypeOfA().cast( converter.getAFromB( beanA.getParameter( "sheepItForm1_riskCat" ) ) ) );
			index++;
   		}
   		
   		/*	Mapping: "risk_riskcat" -> "coverDetails[].riskCodes.riskCat" 
   		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm1_isFreeCover" );
   		index = 0;
   		for(String i : noOfItems ){
   			com.rsaame.pas.cmn.converter.IntegerStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.IntegerStringConverter.class, com.Constant.CONST_BPROPS, com.Constant.CONST_APROPS );
 		...
 		/* Mapping: "item_vsd" -> "coverDetails[].vsd" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm1_vsd" );
  	  	index = 0;
   		for(String i : noOfItems ){
 		...
 		/* Mapping: "risk_id" -> "coverDetails[].riskCodes.risId" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm1_rskId" );
  	  	index = 0;
   		for(String i : noOfItems ){
 		...
 		/* Mapping: "isCovered" -> "coverDetails[].isCovered" */
  		...
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm3_Desc" );
  	  ...
  	  /* Mapping: "staffDOB" -> "staffDetails[].empDob" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm3_sumInsured" );
  	  	index = 0;
  	  	for(String i : noOfItems ){
  	  	...
  	  	/* Mapping: "item_vsd" -> "coverDetails[].vsd" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm3_vsd" );
  	  	index = 0;
  	  	for(String i : noOfItems ){
	  		if(!Utils.isEmpty( beanA.getParameter( i ) ) && !beanA.getParameter( i ).equalsIgnoreCase("null")){
	  			com.mindtree.ruc.cmn.beanmap.DateStringConverter converter = ConverterFactory.getInstance( com.mindtree.ruc.cmn.beanmap.DateStringConverter.class, "", "format=yyyy-MM-dd HH:mm:ss.SSS" );
  	  	...
  	  	/* Mapping: "risk_id" -> "coverDetails[].riskCodes.risId" */
  		noOfItems = HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm3_rskId" );
  	  	index = 0;
  	  	for(String i : noOfItems ){
	  		com.rsaame.pas.cmn.converter.DoubleStringConverter converter = ConverterFactory.getInstance( com.rsaame.pas.cmn.converter.DoubleStringConverter.class, com.Constant.CONST_BPROPS, com.Constant.CONST_APROPS );
	...
	private static com.rsaame.pas.vo.bus.CoverDetails initializeDeepVO( javax.servlet.http.HttpServletRequest beanA, com.rsaame.pas.vo.bus.CoverDetails beanB ){
  		BeanUtils.initializeBeanField( "coverDetails[]", beanB, HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm1_Desc[]" ).size() );
   		BeanUtils.initializeBeanField( "coverDetails[].sumInsured", beanB, HTTPUtils.getMatchingMultiReqParamKeys( beanA, "sheepItForm1_sumInsured[]" ).size() );
