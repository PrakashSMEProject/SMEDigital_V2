...
/**
 * TTrnConsequentialLossQuoId generated by hbm2java
 */
public class TTrnConsequentialLossQuoId  implements java.io.Serializable, POJOId {

	private long colPolicyId;
	private long colEndtId;
	private Date colValidityStartDate;

	public TTrnConsequentialLossQuoId() {
	}

	public TTrnConsequentialLossQuoId(long colPolicyId, long colEndtId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TTrnConsequentialLossQuoId))
			return false;
		TTrnConsequentialLossQuoId castOther = (TTrnConsequentialLossQuoId) other;
