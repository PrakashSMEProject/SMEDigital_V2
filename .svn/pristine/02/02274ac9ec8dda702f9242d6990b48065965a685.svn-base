...
import com.rsaame.kaizen.admin.dao.impl.SystemConfigurationDAOImpl;
...
ServletContextListener{
	   ...
	   //private static BeanFactory factory = BeanFactory.getInstance();
	    private void populateApplicationContext() {
	     ...
	     //   SystemConfigurationDAO systemConfigurationDAO = new SystemConfigurationDAOImpl();
	        ...
	        for (int i = 0; i < loc.length; i++) {
	            ...
	            try {
	            	...
	            	control=new com.rsaame.kaizen.admin.model.Control();
	            	control.setCtlBrCode(20);
	            	control.setCtlCtyCode(1);
	                control.setCtlCoCode(2);
	                control.setCtlRegCode(2);
	                control.setCtlCurrency("1");
	           ...
	           //     BigDecimal exchangeRate = currency.getExchangeRate();
	               ...
	               // String currencyDesc = currency.getEngDesc();
	                String currencyDesc= "UAE DIRHAMS";
	                if (control != null) {
	                ...
	                if(control.getCtlBrCode().toString().equalsIgnoreCase( loc[i] )){
	                	...
	                	com.rsaame.pas.cmn.currency.Currency.setCurrency( 100, "", "", DECIMAL_POINT, 
	    	        			COMMA, "AED","FILS", "UAE DIRHAMS", null,Utils.getSingleValueAppConfig("DEPLOYED_LOCATION") );
